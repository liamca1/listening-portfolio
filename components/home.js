...
function Home() {
  return (
    <div className="dark:bg-black flex flex-col text-sm pl-2 pr-2">
      <div className="grid overflow-hidden dark grid-cols-2 grid-rows-3 gap-1 grid-flow-row lg:w-1/2 md:w-full sm:w-1/1 h-full">
        <div className="box border border-yellow-300 border-t-1 border-l-0 border-r-0 border-b-0">
          <p className="font">Welcome</p>
        </div>
        <div className="box border border-green-600 border-t-1 border-l-0 border-r-0 border-b-0">
          <p className="font">
        ...
        <div className="box border border-red-600 border-t-1 border-l-0 border-r-0 border-b-0">
          <p className="font">Links</p>
          <Link href="www.github.com">Github</Link>
          <br></br>
          <Link href="www.github.com">LinkedIn</Link>
        </div>
        <div className="box border border-blue-600 border-t-1 border-l-0 border-r-0 border-b-0">
